        ...
        ReactNativeBlobUtil.MediaCollection.copyToMediaStore(
          {
            ...
            parentFolder: "classmate", // subdirectory in the Media Store, e.g. HawkIntech/Files to create a folder HawkIntech with a subfolder Files and save the image within this folder
            mimeType: `image/${
              photoUri?.split(".")[photoUri?.split(".")?.length - 1]
            }`,
          },
